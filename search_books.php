   ...
   <section class="show-products">
      <div class="box-container">
         ...
         if (isset($_POST['search_btn'])) {
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM `book_info` WHERE Title LIKE '%{$search_box}%' OR Author LIKE '%{$search_box}%' OR category_name LIKE '%{$search_box}%'");
         ...
         ?>
                  ...
                  <div class="box" style="width: 255px;height: 342px;">
                     ...
                     <div style="text-align:left ;">
                        <div class="name" style="font-size: 12px;">Author: <?php echo $fetch_book['Author']; ?></div>
                        <div style="font-weight: 500; font-size:18px; " class="name">Name: <?php echo $fetch_book['Title']; ?></div>
                     </div>
