...
if (isset($_POST['update'])) {
    ...
    header('location:cart.php'); // Redirect to cart page after updating quantity
    exit; // Added exit to stop further execution
}
...
<body>
    ...
    <div class="cart_form">
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="cart.php" method="POST">
                                    ...
                                    <button type="submit" style="background:transparent;" name="update"><img style="height: 26px; cursor:pointer;" src="./images/update1.png" alt="update"></button>
                                </form>
                            </td>
                            <td><?php echo number_format($row['total']); ?></td>
                            <td><a style="color: red;" href="cart.php?remove=<?php echo $row['id']; ?>">Remove</a></td>
                        </tr>
                <?php
                        $total += $row['total'];
                    }
                } else {
                    echo '<tr><td colspan="6" style="text-align:center;">There is nothing in cart yet !!!!!!!!</td></tr>';
                }
                ?>
                <tr>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php echo ($total > 1) ? 'inline-block' : 'none'; ?>"> &nbsp; Proceed to Checkout</a> <a class="cart-btn2" href="index.php">Continue Shopping</a>
    </div>
